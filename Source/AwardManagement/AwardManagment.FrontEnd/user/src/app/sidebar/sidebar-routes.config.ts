...
export const ROUTES:  RouteInfo[] = [
    { path:  '/jurydashboard', title:  'jury Dashboard', icon:  'material-icons' },

    { path:  '/pages/timeline', title:  'Timeline Page', icon:  'material-icons' },
    { path:  '/pages/user', title:  'User Page', icon:  'material-icons' },

    { path:  '/user/applications', title:  'My Applications', icon: 'pe-7s-plugin' },
    { path:  '/user/apply', title:  'Apply For Award', icon: 'pe-7s-plugin' },
    { path : '/user/userhistory' , title : 'User History' , icon:  'material-icons'},
    { path:  '/user/panels', title:  'Panels', icon: 'pe-7s-plugin' },
    { path:  '/user/sweet-alert', title:  'Sweet Alert', icon: 'pe-7s-plugin' },
    { path:  '/user/notifications', title:  'Notifications', icon: 'pe-7s-plugin' },
    { path:  '/user/icons', title:  'Icons', icon: 'pe-7s-plugin' },
    { path:  '/user/typography', title:  'Typography', icon: 'pe-7s-plugin' },
    ...
    { path:  '/pages/assesor-login', title:  'Assesor Login', icon: 'material-icons' },
    { path:  '/pages/juery-login', title:  'Juery Login', icon: 'material-icons' },
    { path : '/applicant/achivements' , title : 'Achivements' , icon:  'material-icons'},
    { path:  '/user/award', title:  'Award', icon: 'pe-7s-plugin' },
    {path : '/user/applicantprofile', title: ' MyProfile' , icon: 'material-icons'},
    {path : '/pages/login', title: 'Logout' , icon: 'material-icons'},
    {path : '/applicantdashboard', title: 'Dashboard', icon: 'material-icons'},
    {path : '/assesordashboard', title: 'Dashboard', icon: 'material-icons'},
    {path : '/Chairmandashboard', title: 'Dashboard', icon: 'material-icons'},
];
