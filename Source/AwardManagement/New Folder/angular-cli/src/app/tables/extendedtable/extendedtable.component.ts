...
export class ExtendedTableComponent implements OnInit{
    ...
    ngOnInit(){
        ...
        // $('[rel="tooltip"]').tooltip();
        this.tableData1 = {
            headerRow: [ '#', 'Name', 'Award Name', 'Status', 'Application Date','Actions'],
            dataRows: [
                ['1', 'Andrew Mike', 'Best Developer', 'Admin', '09/02/18','btn-round'],
                ['2', 'John Doe', 'Best Designer', 'Admin', '09/02/18', 'btn-round'],
                ['3', 'Alex Mike', 'Best  Designer', 'Admin', '09/02/18', 'btn-round'],
                ['4','Mike Monday', 'Best Marketing head', 'Admin', '09/02/18', 'btn-round'],
                ['5', 'Paul Dickens', 'Best Communication person', 'Admin', '09/02/18', 'btn-round']
            ]
         };
         this.tableData2 = {
